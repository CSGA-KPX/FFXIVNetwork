...
let ServerIpToWorld = new Dictionary<string, LibFFXIV.Network.SpecializedPacket.World>()
...
let Character = new Dictionary<uint64, LibFFXIV.Network.SpecializedPacket.Character>()